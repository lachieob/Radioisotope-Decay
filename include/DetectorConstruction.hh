...
private:
    ...
    G4double           fWorldSizeX_Shield;
    G4double           fWorldSizeY_Shield;
    G4double           fWorldSizeZ_Shield;
    ...
    G4VPhysicalVolume* EncPhysical;
    G4LogicalVolume*   EncLogical;
    G4Box*             EncSolid;
    ...
    G4VPhysicalVolume* myCellPhys;
    G4LogicalVolume*   myCellLog;
    G4Box*             scoreSolid;
